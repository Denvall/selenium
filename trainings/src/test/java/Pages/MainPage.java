...
public class MainPage extends PageObject {
   ...
   /* public WebElement product = driver.findElement(By.cssSelector("#box-campaigns li.product "));
    public WebElement regularPrice = product.findElement(By.cssSelector("*.regular-price"));
    public WebElement salePrice = product.findElement(By.cssSelector("*.campaign-price"));
    public WebElement productName = product.findElement(By.cssSelector("div.name"));
*/
